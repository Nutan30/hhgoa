            ...
            {format === "formatB" && (
              <div className="hh-panel">
                <div className="hh-panel-header">
                  ...
                  <span className="ml-auto bg-[#e619b9] border border-[#000] px-1.5 py-0.5 text-[9px] font-bold text-[#2E7D1A] tracking-wide font-victor shrink-0">
                    ID CARD
                  </span>
                </div>
                <div className="hh-panel-body">
        ...
        <div className="max-w-5xl mx-auto px-6 py-5 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex flex-col items-center gap-2">
            <div className="flex items-center gap-4">
              <a href="https://x.com/247pmstudio" target="_blank" rel="noopener noreferrer" aria-label="X / Twitter"
                className="text-[#FFFBE8]/40 hover:text-[#FEE101] transition-colors">
                <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
                  <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.746l7.73-8.835L1.254 2.25H8.08l4.253 5.622 5.911-5.622Zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
                </svg>
              </a>
              <a href="https://instagram.com/247pmstudio" target="_blank" rel="noopener noreferrer" aria-label="Instagram"
